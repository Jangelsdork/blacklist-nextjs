    ...
    return (
      <form className="form-flow" onSubmit={handleOrgSubmit}>
        ...
        <ul>
          ...
          <li>
            <label htmlFor="company_street">Street name: </label>
            <input name="company_street" type="text" />
          </li>
          <li>
            <label htmlFor="company_street_num">Street number </label>
            <input name="company_street_num" type="text" />
          </li>
          <li>
            <label htmlFor="company_postcode">Postcode: </label>
            <input name="company_postcode" type="text" />
          </li>
          <li>
          ...
          <li>
            <label htmlFor="company_state">State/Provence: </label>
            <input name="company_state" type="text" />
          </li>
          <li>
            <label htmlFor="company_country">Country: </label>
            <input name="company_country" type="text" />
          </li>
          <li>
